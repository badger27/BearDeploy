        ...
        $scope.confirmScore = function(key,note) {
           ...
           var playerRef = new Firebase(FIREBASE_URL + 'bears/poolbear/users/' + note.playerPostUserId );
            ...
            playerRef.on("value", function(snapshot) {
                ...
                var newLostValueUser =   currentUserDetails.wins  + totalNoGames - note.notificationWinsPost;
                var newLostValuePlayer=  currentPlayerDetails.wins + totalNoGames  - note.notificationWinsRecieve;

                var newPointsValueUser = currentUserDetails.points + 10;
                var newPointsValuePlayer = currentUserDetails.points + 10;
