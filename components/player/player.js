...
//       Set the filters in the drop down 
         $scope.playerFilterDropdown = playerFilterObject ;  
          ...
          $scope.test = _.filter(poolBearResultsAllFilter, function (item) {
              console.log("item" , item);
              return item;
          });


            console.log("removeCurrentUser ", $scope.test );
          ...
          $scope.checkForResults = function (idref) {
              ...
              var individualRecordUserRef= new Firebase(FIREBASE_URL + 'bears/poolbear/result/' + $rootScope.currentUser.$id + "/" + idref );
              var individualRecordUserArray=$firebaseArray(individualRecordUserRef);

              if(individualRecordUserArray == null || undefined){

                  console.log("no results exits for:   " +  idref );

              }else{

                  console.log("result exists:   " + idref );
              }
