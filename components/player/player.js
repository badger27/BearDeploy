...
//          Updates Result Record of player
            ...
            var playerResultRef = new Firebase(FIREBASE_URL + 'bears/poolbear/result/' + note.playerPostUserId);
             ...
             console.log("userResultRef " + userResultRef + UserWins );

              var userInfo = {
                 refid:note.playerPostUserId,
                 playerWins:  note.notificationWinsRecieve + userResultRef + playerWins,
                 UserWins: note.playerRecieveLost + userResultRef + UserWins,
                  date: Firebase.ServerValue.TIMESTAMP
              };

            var playerInfo = {
                refid:$rootScope.currentUser.$id,
                playerWins:  note.playerRecieveLost  + playerResultRef + playerWins,
                UserWins: note.notificationWinsRecieve + playerResultRef + UserWins,
                date: Firebase.ServerValue.TIMESTAMP
            };
