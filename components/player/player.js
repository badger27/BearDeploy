...
//            Checks if the confirmedResultObject is the sender or reciever of the notification
            if(confirmedResultObject.sender===true){
                ...
                var newlostValue=  currentUserDetails.lost + confirmedResultObject.playerRecieveLost;

            }else{
                var newWinValue=  currentUserDetails.wins + confirmedResultObject.notificationWinsPost;
                var newlostValue = currentUserDetails.lost + confirmedResultObject.playerPostLost;

            }

             console.log(newWinValue);
              console.log(newlostValue);
             userRef.update({wins:newWinValue, lost:newlostValue}), function (err) {
