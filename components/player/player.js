...
//          passes the result key reference into the recievers notification         
         ...
         console.log("notificationInfoPost" + notificationInfoPost);
//       $firebaseArray creates an empty a
              ...
              console.log("added record with id " + resultId);
...
//              var resultIdref = notificationRef.resultID.key();
//                 console.log("got here");
//              notificationInfoPost.$update ({   
//              
...
//
//    });
              notificationInfoPost.$remove(key);//after confirmation delete notification of reciever
              ...
              var confirmMessageRef = new Firebase(FIREBASE_URL + 'bears/poolbear/notification/' +
               postId + "/" + result);
//       $firebaseArray creates an empty array and placed using the reference create above 
