        ...
        let confirmScore = function (key, note, currentUserId) {
            ...
            playerRef.once("value", function (snapshot) {
                ...
                newPlayerValueObject = {
                    ...
                    newLostValuePlayer: 5,
                    newPointsValuePlayer: currentPlayerDetails.points + 10
                }

                console.log("newPlayerValueObject", newPlayerValueObject);

                if (snapshot.val() === null) {
                    console.log("Snap Shot = null");
                } else {
                    snapshot.ref().update(
                        {   "wins":  newPlayerValueObject.newWinValuePlayer,
                            "lost":  newPlayerValueObject.newLostValuePlayer,
